...
| `pdf-artifact-workflow` | Guardrail for choosing the right PDF path for read/extract, create, review, or verify tasks, with render-first proof when layout matters and OCR as an explicit branch for scan-derived or image-only PDFs. | `pdf`, `documents`, `ocr`, `render`, `qa` | `skills/pdf-artifact-workflow/SKILL.md` | available |
| `phaser-2d-game-development` | Guardrail for Phaser 2D browser-game implementation and review. | `browser-games`, `phaser`, `planning`, `qa` | `skills/phaser-2d-game-development/SKILL.md` | available |
...
| `product-ui-polish-review` | Guardrail for reviewing and polishing product UI reward moments, typography, spacing, hierarchy, and perceived-quality details without drifting into manipulative retention design. | `frontend`, `design`, `ui-polish`, `typography`, `ethics` | `skills/product-ui-polish-review/SKILL.md` | available |
