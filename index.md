...
| `dynamic-og-images` | Guardrail for choosing Next.js metadata routes, route handlers with `ImageResponse`, or standalone Satori for dynamic OG and social preview images. | `nextjs`, `satori`, `og-images`, `planning`, `preview` | `skills/dynamic-og-images/SKILL.md` | available |
